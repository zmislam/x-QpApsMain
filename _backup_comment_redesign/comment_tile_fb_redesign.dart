              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    // ========================================= Main comments Action Section (Facebook-style) =========================================
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Spacer(),
                          // ── Thumbs up / down (Facebook-style) ──
                          InkWell(
                            onTap: () {
                              onSelectCommentReaction('like');
                            },
                            child: Icon(
                              Icons.thumb_up_alt_outlined,
                              size: 16,
                              color: getSelectedCommentReaction(
                                          commentModel,
                                          currentUserModel.id ?? '') !=
                                      null
                                  ? PRIMARY_COLOR
                          ...
                          InkWell(
                            onTap: () {
                              onSelectCommentReaction('dislike');
                            },
                            child: Icon(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              replyMedia.isNotEmpty
                                  ...
                                  : const SizedBox.shrink(),
                              // ── Reply Action Row (Facebook-style) ──
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 4, right: 4, top: 4, bottom: 2),
                                child: Row(
