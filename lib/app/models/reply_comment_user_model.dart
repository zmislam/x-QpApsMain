...
class ReplyCommentUserIdModel {
  ...
  ReplyCommentUserIdModel copyWith(
      {String? websites,
      String? user_nickname,
      String? user_about,
      String? present_town,
      ...
      String? lock_profile,
      bool? isFollowing}) {
    return ReplyCommentUserIdModel(
  ...
  factory ReplyCommentUserIdModel.fromMap(Map<String, dynamic> map) {
    return ReplyCommentUserIdModel(
