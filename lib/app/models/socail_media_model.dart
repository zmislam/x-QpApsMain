...
class SocialMedia {
  ...
  factory SocialMedia.fromMap(Map<String, dynamic> map) {
    return SocialMedia(
      ...
      media_name: map['media_name'] != null ? map['media_name'] as String : null,
      icon: map['icon'] != null ? map['icon'] as String : null,
      base_url: map['base_url'] != null ? map['base_url'] as String : null,
      data_status: map['data_status'] != null ? map['data_status'] as String : null,
  ...
  @override
  String toString() {
    return 'SocialMedia(id: $id, media_name: $media_name, icon: $icon, base_url: $base_url, data_status: $data_status, ip_address: $ip_address, created_by: $created_by, update_by: $update_by, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
