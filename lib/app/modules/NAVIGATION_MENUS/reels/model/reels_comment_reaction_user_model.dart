...
class CommentReactedUserIdModel {
  String? id;
  String? first_name;
  String? last_name;
  String? username;
  ...
  CommentReactedUserIdModel copyWith({
    String? id,
    String? first_name,
    String? last_name,
    String? username,
    ...
    return CommentReactedUserIdModel(
      id: id ?? this.id,
  ...
  factory CommentReactedUserIdModel.fromMap(Map<String, dynamic> map) {
    return CommentReactedUserIdModel(
