...
class ReelsReactedUserIdModel {
  ...
  ReelsReactedUserIdModel copyWith({
    String? id,
    String? first_name,
    String? last_name,
    String? username,
    ...
    return ReelsReactedUserIdModel(
      id: id ?? this.id,
  ...
  factory ReelsReactedUserIdModel.fromMap(Map<String, dynamic> map) {
    return ReelsReactedUserIdModel(
  ...
  factory ReelsReactedUserIdModel.fromJson(String source) =>
      ReelsReactedUserIdModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant ReelsReactedUserIdModel other) {
