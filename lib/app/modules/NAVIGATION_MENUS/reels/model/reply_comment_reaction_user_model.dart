...
class RepliesCommentUserIdModel {
  String? id;
  String? first_name;
  String? last_name;
  String? username;
  ...
  RepliesCommentUserIdModel copyWith({
    String? id,
    String? first_name,
    String? last_name,
    String? username,
    ...
    return RepliesCommentUserIdModel(
      id: id ?? this.id,
  ...
  factory RepliesCommentUserIdModel.fromMap(Map<String, dynamic> map) {
    return RepliesCommentUserIdModel(
