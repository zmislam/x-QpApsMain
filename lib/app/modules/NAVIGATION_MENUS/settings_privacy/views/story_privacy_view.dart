...
class StoryPrivacyView extends GetView<SettingsPrivacyController> {
  const StoryPrivacyView({super.key});

  @override
  Widget build(BuildContext context) {
    controller.getPostOrStoryPrivacy('story');
          ...
          return Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text('Stories Privacy Settings'.tr,
                    style: TextStyle(
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        ...
                        controller.updatePrivacyInfo('story', seePostValue,
                            sharePostValue, commentPostValue);
                      },
