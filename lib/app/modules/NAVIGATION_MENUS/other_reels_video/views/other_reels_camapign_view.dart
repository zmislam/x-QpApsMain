...
class OtherReelsCampaignView extends GetView<OtherReelsVideoController> {
  const OtherReelsCampaignView({Key? key}) : super(key: key);
                    ...
                    showDraggableScrollableBottomSheet(context,
                        child: ShareSheetWidget(
                            ...
                            userId:
                                controller.loginCredential.getUserData().id ??
                                    '',
                            campaignId: reelsCampaignModel.id ?? ''));
                  },
                  onPressedViewReact: () {
                          ...
                          child: ReelsCampaignCommentComponent(
                            ...
                            onTapSendReelsComment: () {
                              controller.reelsComments(
                                  ...
                                  index, controller.processedCommentFileData.value, reelsCampaignModel.key ?? '');
