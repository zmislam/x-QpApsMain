...
class PageInvites extends StatefulWidget {
  const PageInvites({super.key});

  @override
  State<PageInvites> createState() => _InvitesState();
}

class _InvitesState extends State<PageInvites> {
  @override
