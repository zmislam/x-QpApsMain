              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      if (controller.bioLength.value > 400)
                        Flexible(
                          child: Text(
                            'Text exceeds 400 characters'.tr,
                      ...
                      const Spacer(),
                      Text(
                        '${controller.bioController.text.length} / 400',
                        style: TextStyle(
                          fontSize: 12,
                          color: controller.bioController.text.length > 400
                              ? Colors.red
                              : textSecondary,
                        ),
                      ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () => controller.onTapEditBioPatch(),
