  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Obx(() => Text(
              controller.isEditing.value ? 'Edit Place'.tr : 'Add Place'.tr,
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // ── Place type dropdown ──
              Text('Place type'.tr, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: textPrimary)),
              ...
              // ── Address field ──
              Obx(() => _buildOutlinedField(
                    controller: controller.placeAddressController,
                    label: controller.placeDropdownalue.value == 'Home Town' ? 'Home town'.tr : 'Current city'.tr,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => controller.onTapEditPlacesLivedPost(),
