...
import '../../../../../../../../components/thumbnail/thumbnail_from_video.dart';
...
class UploadVideos extends StatelessWidget {
  const UploadVideos(
      {super.key, required this.controller, required this.videoModel});
  final VideosGalleryController controller;
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Enter a description for the video'.tr,
                    ),
                  ),
                  const SizedBox(height: 20),
                  Container(
                            ...
                            return Stack(
                              children: [
                                Padding(
                                  ...
                                  child: ThumbnailFromVideo(
                                      videoFilePath: xFile.path),
                                ),
                                Positioned(
                                  top: 5,
                                  right: 10,
                      ...
                      onPressed: controller.isSaveButtonEnabled.value == false
                          ? () {
                              if (controller.formKey.currentState?.validate() ??
                                  false) {
                                controller.saveVideos(videoModel.albumId ?? '');
                              }
                            }
                          : null,
                      child: Text('Save'.tr,
