...
class EditGenderView extends GetView<EditGenderController> {
  const EditGenderView({
    super.key,
  });
          ...
          children: [
              ...
              return Padding(
                  ...
                  child: Container(
                    ...
                    child: DropdownButton<String>(
                      value: controller.genderDropdownalue.value,
                      isExpanded: true,
                      onChanged: (newValue) {
            ...
            SizedBox(
              ...
              child: Padding(
                ...
                child: PrimaryButton(
                  onPressed: () {
                    controller.onTapEditGenderPatch();
                  },
                  text: 'Save'.tr,
