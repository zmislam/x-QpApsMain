...
class EditGenderController extends GetxController {
  ...
  RxString genderDropdownalue = 'Male'.obs;
...
/*=============== Edit Gender API=====================*/
  Future<void> onTapEditGenderPatch() async {
    final ApiResponse response = await _apiCommunication.doPatchRequest(
      apiEndPoint: 'update-user-gender',
      isFormData: false,
      enableLoading: true,
      requestData: {
  ...
  String getGenderId() {
    switch (genderDropdownalue.value) {
      case 'Male':
        return '5018b21577b4590853ef574';
      case 'Female':
        return '65018b27577b4590853ef576';
      case 'Others':
        return '65018b2d577b4590853ef578';
      default:
        return '';
    }
  }
  ...
  setSelectedDropdownValue(String value) {
    genderDropdownalue.value = value;
  ...
  void onInit() {
    ...
    setSelectedDropdownValue(gender);
