...
class GroupAddAdminModeratorView extends GetView<GroupSettingsController> {
  const GroupAddAdminModeratorView({super.key});

  @override
  Widget build(BuildContext context) {
    RxList<String> roles = ['Admin', 'Moderator'].obs;
    controller.selectedGroupMemberList.clear();
    controller.allGroupMemberList.clear();
    controller.filteredMemberList.clear();
            ...
            children: [
              ...
              Obx(
                () => SecondaryDropDownField(
                  list: roles,
                  selectedItem: controller.selectedUserRole.value.isEmpty
                      ? null
                      : controller.selectedUserRole.value,
                  onChanged:
              ...
              Obx(
                () => Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      if (controller.selectedGroupMemberList.isNotEmpty) {
                        controller.addAdminOrModerator();
                      }
                    },
                    child: Text('Add'.tr,
                      style: TextStyle(
