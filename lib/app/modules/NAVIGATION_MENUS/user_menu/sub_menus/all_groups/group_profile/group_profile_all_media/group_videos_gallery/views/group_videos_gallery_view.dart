...
class GroupVideosGalleryView extends GetView<GroupVideosGalleryController> {
  const GroupVideosGalleryView({super.key});
            ...
            child: Obx(
              () {
                if (controller.isLoadingUserVideo.value) {
                  return ShimmarLoadingView(); // Show loading indicator
                }
                if (controller.videoList.value.isEmpty) {
                  return Center(
                          ...
                          InkWell(
                            onTap: () {
                              Get.to(NewsFeedPostVideoPlayer(
                                ...
                                // isPostPreview: true,
                                videoSrc:
                                    (videoModel.media ?? '').formatedVideoUrl,
                              ));
                            },
                            child: Card(
                              elevation: 2,
