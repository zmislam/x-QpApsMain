...
class GroupPhotoModel {
  ...
  factory GroupPhotoModel.fromJson(String source) =>
      GroupPhotoModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'GroupPhotoModel(id: $id, caption: $caption, video_thumbnail: $video_thumbnail, media: $media, post_id: $post_id, status: $status, ip_address: $ip_address, created_by: $created_by, update_by: $update_by, createdAt: $createdAt, updatedAt: $updatedAt, v: $v, key: $key)';
  }
