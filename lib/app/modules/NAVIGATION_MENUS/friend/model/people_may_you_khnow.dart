...
class PeopleMayYouKnowModel {
  ...
  PeopleMayYouKnowModel copyWith({
    String? id,
    List<String>? email_list,
    List<String>? phone_list,
    String? websites,
  ...
  factory PeopleMayYouKnowModel.fromMap(Map<String, dynamic> map) {
    return PeopleMayYouKnowModel(
      id: map['_id'] != null ? map['_id'] as String : null,
      // email_list: map['email_list'] != null
      //     ? List<String>.from((map['email_list'] as List<String>))
      //     : null,
      // phone_list: map['phone_list'] != null
      //     ? List<String>.from((map['phone_list'] as List<String>))
      //     : null,
  ...
  factory PeopleMayYouKnowModel.fromJson(String source) =>
      PeopleMayYouKnowModel.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'PeopleMayYouKnowModel(id: $id, email_list: $email_list, isProfileVerified: $isProfileVerified, phone_list: $phone_list, websites: $websites, user_nickname: $user_nickname, user_about: $user_about, present_town: $present_town, lock_profile: $lock_profile, first_name: $first_name, last_name: $last_name, username: $username, email: $email, phone: $phone, password: $password, profile_pic: $profile_pic, cover_pic: $cover_pic, user_status: $user_status, gender: $gender, religion: $religion, date_of_birth: $date_of_birth, user_bio: $user_bio, language: $language, passport: $passport, last_login: $last_login, user_2fa_status: $user_2fa_status, secondary_email: $secondary_email, recovery_email: $recovery_email, relation_status: $relation_status, home_town: $home_town, birth_place: $birth_place, blood_group: $blood_group, reset_password_token: $reset_password_token, reset_password_token_expires: $reset_password_token_expires, user_role: $user_role, status: $status, ip_address: $ip_address, created_by: $created_by, update_by: $update_by, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }

  @override
  bool operator ==(covariant PeopleMayYouKnowModel other) {
