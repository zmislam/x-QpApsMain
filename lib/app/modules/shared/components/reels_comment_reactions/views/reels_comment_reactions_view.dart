...
import '../../../../NAVIGATION_MENUS/reels/model/reels_comment_reaction_user_model.dart';
...
class ReelsCommentReactionsView
    extends GetView<ReelsCommentReactionsController> {
  const ReelsCommentReactionsView({Key? key}) : super(key: key);
  @override
                          ...
                          Obx(() => controller.reactionList.value.isNotEmpty
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ReelsCommentReactionModel model =
                                        controller.reactionList.value[index];
                                    CommentReactedUserIdModel? userIdModel =
                                        model.user_id;
                          ...
                          Obx(() => controller.unlikeList.value.isNotEmpty
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    CommentReactedUserIdModel? userId =
                                        model.user_id;
