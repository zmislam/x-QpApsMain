...
class OtherUserFollowerListComponent extends StatelessWidget {
  final OthersProfileController controller;
  const OtherUserFollowerListComponent({super.key, required this.controller});
          ...
          child: Obx(() => controller.isLoadingFollowerList.value == true
              ...
              : controller.followerController.value == ''
                            ...
                            child: FollowerCard(
                              ...
                              onTapBlock: () {
                                controller.blockFriends(controller
                                        .followerList.value[index].userId?.id ??
                                    '');
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        UserId userModel =
                            controller.searchFollowerList.value[index].userId!;
                        return InkWell(
                          onTap: () {
