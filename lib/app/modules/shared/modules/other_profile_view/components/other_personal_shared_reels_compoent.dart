...
class OtherPersonalSharedReelComponent extends StatelessWidget {
  const OtherPersonalSharedReelComponent({super.key, required this.controller});
      ...
      if (controller.isLoadingUserRepost.value) {
        ...
        return Center(
          child: Padding(
            ...
            child: Text('User has no reposted reels'.tr,
              style: TextStyle(
                fontSize: 16,
        ...
        return Column(
          children: [
            ...
            controller.hasMoreRepostedReels.value == true
                ? PrimaryButton(
                    onPressed: () {
