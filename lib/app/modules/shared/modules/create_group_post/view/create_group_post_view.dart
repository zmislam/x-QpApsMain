...
import '../media_component/group_media_layout_component.dart';
import '../media_component/group_primary_file_media_component.dart';

class CreateGroupPostView extends GetView<CreateGroupPostController> {
  const CreateGroupPostView({super.key});
          ...
          children: [
            ...
            Obx(
              () => Visibility(
                ...
                child: (controller.selectedMediaLayout.value?.title == 'none' ||
                    ...
                    : GroupPrimaryFileMediaComponent(
                        // index:0,
                        mediaUrlList:
            ...
            Obx(
              () => Visibility(
                ...
                child:
                    GroupMediaLayoutComponent(createPostController: controller),
              ),
            ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        // InkWell(
                        //   onTap: () async {
                        //     final value = await Get.toNamed(Routes.CHECKIN);
                        //     if (value != null) {
                        //       controller.locationName.value =
                        //           value as AllLocation;
                        //     }
                        //
                        //     debugPrint(
