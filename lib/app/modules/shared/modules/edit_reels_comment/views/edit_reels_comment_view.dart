...
class EditReelsCommentView extends GetView<EditReelsCommentController> {
  const EditReelsCommentView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Edit Reels Comment'.tr,
            style: TextStyle(
              color: Colors.black,
                ...
                child: Row(
                  ...
                  const  SizedBox(width: 20),
                    PrimaryButton(
                      ...
                      borderRadius: BorderRadius.circular(5),
                      onPressed: () {
                        controller.onTapEditReelsComment();
                      },
                      text: 'Update'.tr,
                      horizontalPadding: 20,
                      verticalPadding: 10,
