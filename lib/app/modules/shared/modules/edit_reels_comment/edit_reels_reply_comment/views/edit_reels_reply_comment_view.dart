...
class EditReelsReplyCommentView extends GetView<EditReelsReplyCommentController> {
  const EditReelsReplyCommentView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Edit Reels Comment Reply'.tr,
            style: TextStyle(
              color: Colors.black,
