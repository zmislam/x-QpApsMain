...
class EditReelsCommentController extends GetxController {
...
/*=============== Edit Comment  API=====================*/
  Future<void> onTapEditReelsComment() async {

    final ApiResponse response = await _apiCommunication.doPostRequestNew(
      apiEndPoint: 'reels/update-comments-by-reel-post/:$postCommentId/:$commentId',
      enableLoading: true,
      requestData: {
    ...
    if (response.isSuccessful) {
      debugPrint('API SUUUCREESSS: $response');
