...
class RelationshipSubTypeBody extends StatelessWidget {
  const RelationshipSubTypeBody({
    super.key,
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Column(
            children: [
              PrimaryDropDownSearch<FriendModel>(
                ...
                onChanged: (friendModel) {
                  controller.partnerName.value = friendModel?.friend?.id ?? '';
                },
              ),
              const SizedBox(
                height: 10,
