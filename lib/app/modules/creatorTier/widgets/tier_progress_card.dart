...
import 'creator_tier_badge.dart';

/// Tier progress with dimension bars — dimension names + weights from API (dynamic)
class TierProgressCard extends GetView<CreatorTierController> {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (tier.nextTierThreshold > 0 && tier.nextTier.isNotEmpty) ...[
  ...
  Widget _nextTierProgress(CreatorTierInfo tier) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Text('Progress to ${tier.nextTier}',
                  style: const TextStyle(fontSize: 12)),
              const Spacer(),
  ...
  Widget _historyItem(TierHistoryEntry entry) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
              child: Text('${entry.fromTier} → ${entry.toTier}',
                  style: const TextStyle(fontSize: 12))),
          if (entry.date != null)
            Text(
