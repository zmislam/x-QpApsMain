...
class EducationalWorkPlaceTile extends StatelessWidget {
  EducationalWorkPlaceTile({
    super.key,
    this.workIcon,
    required this.model,
  });
            ...
            Row(
              children: [
                ...
                EditProfilePopUpMenu(
                  onTapDelete: () {
                    aboutController.onTapDeleteInstitutePost(model.id ?? '');
                  },
                  onTapEdit: () {
                    Get.toNamed(Routes.ADD_EDUCATION, arguments: model);
                  },
                )
              ],
            )
