...
import 'suggested_pages_widget.dart';
...
class AllSuggestedPagesWidget extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: AllSuggestedPagesView(context),
    );
  }

  Widget AllSuggestedPagesView(BuildContext context) {
    return Obx(() => Column(
          children: [
            // const Divider(),
            Align(
              ...
              child: Padding(
                ...
                child: Text('Pages You May Like'.tr,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return SuggestedPagesWidget(
                    pageModel: controller.suggestedPageList.value[index],
                    onFollowClick: () {
                      controller.followPage(
                          pageId:
                              controller.suggestedPageList.value[index].id ??
                                  '');
                    },
                  );
                },
            ...
            InkWell(
              ...
              onTap: () {
                ...
                if (loginCredential.getProfileSwitch()) {
                  // * GOING TO PAGE TAB IF ON PAGE PROFILE
                  tabViewController.tabController.animateTo(2);
                } else {
                  // * GOING TO PAGE TAB IF ON GENERAL PROFILE
